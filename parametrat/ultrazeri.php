            ...
            <section class="manage">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                ...
                Moti sot
                    ...
                    <li style="border-bottom: 1px solid rgba(255, 159, 64, 1);border-radius: 25px;" class="active">
        ...
        <section class="container">
            ...
            <div class="content">
                ...
                <div id="noDataMessage" class="no-data-message"></div>
                    <canvas id="ultrasoundChart" class="chart"></canvas>
                    <div id="ultrasoundStats" class="stats"></div>
                </div>
            </div>
        </section>
...
<script>
    ...
    if (allDataEmpty) {
        ...
        if (data.US) createChart('ultrasoundChart', 'Ultrasound', data.US, overallStats.US, 12);
    }
</script>
