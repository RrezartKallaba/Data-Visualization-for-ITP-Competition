            ...
            <section class="manage">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                ...
                Moti sot
                    ...
                    <li style="border-bottom: 1px solid rgba(75, 192, 192, 1);border-radius: 25px;" class="active">
    ...
    <main class="content-wrap">
        <section class="container">
            ...
            <div class="chart-container">
                ...
                <canvas id="soilMoistureChart" class="chart"></canvas>
                <div id="soilMoistureStats" class="stats"></div>
            </div>
        </section>
        ...
        <script>
            ...
            if (allDataEmpty) {
                ...
                if (data.SOIL1) createChart('soilMoistureChart', 'Soil Moisture', data.SOIL1, overallStats.SOIL1, 12);
            }
        </script>
    </main>
