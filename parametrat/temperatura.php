            ...
            <section class="manage">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                ...
                Moti sot
                    ...
                    <li style="border-bottom: 1px solid rgba(255, 99, 132, 1);border-radius: 25px;" class="active">
        ...
        <script>
            ...
            window.onload = function() {
                ...
                if (allDataEmpty) {
                    ...
                    if (data.TC) createChart('temperatureChart', 'Temperature', data.TC, overallStats.TC, 12);
                }
            }
        </script>
