    ...
    <main class="content-wrap">
        <section class="container">
            ...
            <div class="content">
                <div class="chart-container">
                    ...
                    <canvas id="airHumidityChart" class="chart"></canvas>
                    <div id="airHumidityStats" class="stats"></div>
                </div>
            </div>
        ...
        <script>
            ...
            if (allDataEmpty) {
                ...
                if (data.HUM) createChart('airHumidityChart', 'Air Humidity', data.HUM, overallStats.HUM, 12);
            }
        </script>
    </main>
